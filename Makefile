...
build-lib:
	...
	$(GOBUILD) -buildmode=c-shared -o distconf/libdistconf/libdistconf.so ./src/cgo_bridge/...
...
build-dll:
	...
	CGO_ENABLED=1 GOOS=windows GOARCH=amd64 $(GOBUILD) -buildmode=c-shared -o distconf/libdistconf/libdistconf.dll ./src/cgo_bridge/...
